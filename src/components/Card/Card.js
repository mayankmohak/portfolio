...
class Card extends Component {
    render() {
        ...
        if (check) {
            this.website = <a target="_blank" rel="noreferrer" href={this.props.hostlink} ><img id="shadow" src={websiteIcon} height="50px" alt="Website"></img></a>;
        }
        ...
        if (pos) {
            rend =
                <a target="_blank" rel="noreferrer" href={this.props.gitlink} className="row">
                ...
                <a target="_blank" rel="noreferrer" href={this.props.gitlink} className="row">
                    <div className="col-md-6">
                        <div className="card-body">
                            ...
                            {this.website}
                        &nbsp;&nbsp;&nbsp;&nbsp;
                        <a target="_blank" rel="noreferrer" href={this.props.gitlink} ><img id="shadow" src={githubIcon} height="50px" alt="GitHub"></img></a>
                        </div>
                    </div>
                    <div className="col-md-6">
                        <img src={this.props.img} alt="Project Thumbnail" className="card-img-top" height="300px" />
